...
function createSetupEmbed(interfaceType = 'standard') {
  const embed = new EmbedBuilder()
    ...
    .setDescription('Bienvenue sur Vocal Manager ! Ce puissant système permet aux utilisateurs de créer et de gérer leurs propres vocaux temporaires.')
    .addFields(
      { 
        name: '🔧 Configuration terminé', 
        value: 'Le système de Vocal Manager a été configuré avec succès sur ce serveur.', 
        inline: false 
      },
      { 
        name: '📋 Instructions', 
        value: 
          '1. Rejoindre le salon de création\n' +
          '2. Une vocal temporaire personnel vous sera attribué\n' +
          '3. Utilisez le tableau de gestion pour modifier votre vocal \n' +
          '4. Le salon sera supprimé une fois que vous quitterez le salon vocal',
        inline: false 
      },
      {
        name: '✨ Nouveautées',
        value:
          ...
          '• Choisir la limite d\'utilisateur\n' +
    ...
    .setTimestamp()
    .setFooter({ text: 'Vocal Manager • Configuration terminé', iconURL: 'https://media.discordapp.net/attachments/1298760976501571655/1352307804106653756/IMG_0468.jpg?ex=67dd8a49&is=67dc38c9&hm=fa8156fd2e23b6763ca338313e4ff00ee8f53dddb265a02c163445aea16d617d&' });

  if (interfaceType === 'advanced') {
    embed.addFields({
      name: '⚙️ Mode avancée',
      value: 'Ce serveur utilise une configuration du bot avancée.',
      inline: false
    });
  }
...
function createSetupButtons() {
  const setupButton = new ButtonBuilder()
    ...
    .setLabel('Configuration standard')
